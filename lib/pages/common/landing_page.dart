      ...
      body: BlueprintBackground(
        ...
        child: SingleChildScrollView(
          ...
          children: [
            ...
            FadeIn(delay: const Duration(milliseconds: 330), child: KeyedSubtree(key: _demoKey, child: _DemoSection(isWide: isWide)) ),
            const SizedBox(height: 36),
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Try the demo', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700)),
                  const SizedBox(height: 8),
                  const Text('Explore JobScaffold with a sample project — no signup required.'),
                  const SizedBox(height: 16),
                  Wrap(
                    spacing: 12,
                    runSpacing: 12,
